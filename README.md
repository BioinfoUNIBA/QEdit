...
Run the get_DE_events.py script (with Mann-Whitney U-test) on multiple REDItools tables according to the sample/Group subdivions reported in the sample informations file (.sif).
