...
<b>Note</b>. The script assumes that REDItools outputs (e.g. SRR1071289, SRR1101591) are contained in a "tables" folder in your main working directory, otherwise modify the <a href="https://raw.githubusercontent.com/BioinfoUNIBA/QEdit/master/scripts/sample_path_folder_creator.py">last line</a> of the script accordingly.
